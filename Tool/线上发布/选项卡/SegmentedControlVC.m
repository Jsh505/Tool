...
@interface SegmentedControlVC () <UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    HMSegmentedControl *segmentedControl = [[HMSegmentedControl alloc] initWithSectionTitles:@[@"默认", @"简单", @"样式"]];
    segmentedControl.frame = CGRectMake(0, 20, SCREEN_WIDTH, 40);
...
//    segmentedControl2.imagePosition = HMSegmentedControlImagePositionLeftOfText;  //图片展示样式   pod 没更新，下载本地包才有
    segmentedControl2.frame = CGRectMake(0, 120, SCREEN_WIDTH, 50);
    ...
    [segmentedControl3 setFrame:CGRectMake(0, 180, SCREEN_WIDTH, 50)];
    ...
    self.segmentedControl4 = [[HMSegmentedControl alloc] initWithFrame:CGRectMake(0, 260, SCREEN_WIDTH, 50)];
    ...
    self.scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 310, SCREEN_WIDTH, 210)];
    ...
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 210)];
    [self setApperanceForLabel:label1];
    label1.text = @"Worldwide";
    [self.scrollView addSubview:label1];
    
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH, 0, SCREEN_WIDTH, 210)];
    [self setApperanceForLabel:label2];
    label2.text = @"Local";
    [self.scrollView addSubview:label2];
    
    UILabel *label3 = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 2, 0, SCREEN_WIDTH, 210)];
